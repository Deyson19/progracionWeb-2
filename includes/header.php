...
<head>
    ...
    <link href="/fontAwesome/fontawesome.css" rel="stylesheet">
...
<body>
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="contactar.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="my_login/register.php">
            ...
            <li class="nav-item">
                <a href="my_login" id="btn_to_login" class="btn btn-info">
